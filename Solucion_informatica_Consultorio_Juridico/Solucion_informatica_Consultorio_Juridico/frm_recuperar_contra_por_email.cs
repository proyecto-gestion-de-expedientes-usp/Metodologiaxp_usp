...
{
    public partial class frm_recuperar_contra_por_email : Form
    {
        public frm_recuperar_contra_por_email()
        {
            InitializeComponent();
        }

        private void frm_recuperar_contra_por_email_Load(object sender, EventArgs e)
        {
